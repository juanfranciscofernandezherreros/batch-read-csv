...
@Service
public class DownloadTransferServiceImpl implements DownloadFileService {

    private Logger logger = LoggerFactory.getLogger(DownloadTransferServiceImpl.class);
